...
for src in ScoreTrackerPlugin NotificationOverlay B2STracker NvramTracker ScoresFileWriter ScoreSignature common; do
...
/usr/bin/c++ -O3 -DNDEBUG -arch "$ARCH" -mmacosx-version-min=14.0 -bundle -Wl,-headerpad_max_install_names \
  ...
  "$WORK_DIR/ScoreTrackerPlugin.cpp.o" "$WORK_DIR/NotificationOverlay.cpp.o" "$WORK_DIR/B2STracker.cpp.o" "$WORK_DIR/NvramTracker.cpp.o" "$WORK_DIR/ScoresFileWriter.cpp.o" "$WORK_DIR/ScoreSignature.cpp.o" "$WORK_DIR/common.cpp.o" \
